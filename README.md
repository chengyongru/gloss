...
`Launch at startup` 默认为关闭，可在 Settings 中切换。代理可以填写完整 URL，也可以直接填写 `127.0.0.1:23458`；后者会按 `http://127.0.0.1:23458` 处理。代理用于 OAuth 令牌交换和 AI 请求，浏览器授权页面仍使用浏览器自身的网络设置。
